...
export default function ContactPage() {
  return (
    <MainLayout>
      <section className="paper-grid flex min-h-[85vh] items-center pt-28 pb-20">
        <Container>
          <div className="grid gap-14 lg:grid-cols-[1.15fr_.85fr] lg:items-end">
            <div>
              <p className="text-xs font-bold uppercase tracking-[.24em] text-[#2f7d50]">Contacto</p>
              <h1 className="mt-6 max-w-4xl text-5xl font-extrabold leading-[.93] tracking-[-.07em] text-[#10261d] sm:text-7xl lg:text-8xl">¿Tienes un desafío que podamos resolver?</h1>
              <p className="mt-8 max-w-2xl text-lg leading-8 text-[#52665c]">Estoy disponible para oportunidades como desarrollador, colaboraciones y proyectos relacionados con aplicaciones web, datos y automatización de procesos.</p>
            </div>
            <aside className="rounded-[2rem] bg-[#10261d] p-7 text-[#eef3ec] sm:p-9">
