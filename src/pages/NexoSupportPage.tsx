...
export default function NexoSupportPage() {
  return (
    <MainLayout>
      <section className="paper-grid pt-32 pb-20 sm:pt-40 sm:pb-28">
        <Container>
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1.25fr_.75fr] lg:items-end">
            <div><p className="text-xs font-bold uppercase tracking-[.24em] text-emerald-400">Caso de estudio · Producto full stack</p><h1 className="mt-5 text-6xl font-extrabold leading-[.9] tracking-[-.075em] text-zinc-100 sm:text-8xl">Nexo<br />Soporte.</h1></div>
      ...
      <section className="border-y border-zinc-800 bg-zinc-900 py-12 sm:py-16"><Container><img src="/nexo-dashboard.png" alt="Dashboard de Nexo Soporte con métricas operativas ficticias" className="w-full rounded-2xl border border-white/10 shadow-2xl" /></Container></section>
      ...
      <section className="border-y border-zinc-800 bg-zinc-900/60 py-24 sm:py-32">
        <Container>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-2 lg:items-center"><img src="/nexo-historial.png" alt="Historial de incidencias ficticias de Nexo Soporte" className="rounded-2xl border border-zinc-700 shadow-xl" /><div><p className="text-xs font-bold uppercase tracking-[.24em] text-emerald-400">Alcance funcional</p><ul className="mt-7 space-y-4">{features.map((feature) => <li key={feature} className="flex gap-3 leading-7 text-zinc-300"><CheckCircle2 size={20} className="mt-1 shrink-0 text-emerald-400" />{feature}</li>)}</ul></div></div>
        </Container>
      </section>
