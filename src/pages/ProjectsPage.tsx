    ...
    <MainLayout>
      <section className="pt-36 pb-20 sm:pt-44 sm:pb-28">
        <Container className="grid gap-8 lg:grid-cols-[.65fr_1.35fr]">
          ...
          <div><h1 className="text-5xl font-extrabold leading-[.95] tracking-[-.065em] text-zinc-100 sm:text-7xl">Una solución construida para un problema real.</h1><p className="mt-7 max-w-2xl text-lg leading-8 text-zinc-400">Una plataforma que evolucionó desde el registro de soporte hacia la integración de mensajes, automatización y análisis operacional de datos.</p></div>
        </Container>
      </section>
